...
namespace DBapplication
{
    public class Controller
    {
        ...
        public int InsertWork(string nat_id, string hosp_id)
        {
            string query = "INSERT INTO Work_In (National_ID, Hospital_ID) " +
                            "Values ('" + nat_id + "','" + hosp_id + "');";
            return dbMan.ExecuteNonQuery(query);
        }
        ...
        public int DeleteStaffMember(int id)
        {
        ...
        public int InsertOfferedBy(string hosp_id, string nat_id)
        {
            string query = "INSERT INTO Offered_By (Service_ID, Hospital_ID) " +
                            "Values ('" + hosp_id + "','" + nat_id + "');";
            return dbMan.ExecuteNonQuery(query);
        }
        ...
        public int InsertStaffMember(int national_id, string fname, string lname, string field, string graduated, string certificate)
        {
            string query = "INSERT INTO Medical_Staff (National_ID, FName, LName, Field, Graduated_From, Certificate) " +
                            "Values ('" + national_id + "','" + fname + "','" + lname + "','" + field + "','" + graduated + "','" + certificate + "');";
            return dbMan.ExecuteNonQuery(query);
        ...
        {
            string query = "SELECT National_ID, FName, Age, Vaccinated, S_name FROM Citizen, Request, Service " +
